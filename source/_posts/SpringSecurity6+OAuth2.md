---
title: SpringSecurity6+OAuth2
date: 2024-06-05 15:15:16
tags:
...
![image-20230410140908841](SpringSecurity6+OAuth2/image-20230410140908841.png)
...
![image-20231130152247055](SpringSecurity6+OAuth2/image-20231130152247055.png)

否则你的登录页会加载很久，并且看到的页面是这样的（登录按钮没有样式文件渲染，但是不影响登录功能的执行）

![image-20231130152345471](SpringSecurity6+OAuth2/image-20231130152345471.png)
...
![filterchain](SpringSecurity6+OAuth2/filterchain.png)
...
![delegatingfilterproxy](SpringSecurity6+OAuth2/delegatingfilterproxy.png)
...
![filterchainproxy](SpringSecurity6+OAuth2/filterchainproxy.png)
...
![securityfilterchain](SpringSecurity6+OAuth2/securityfilterchain.png)
...
![multi securityfilterchain](SpringSecurity6+OAuth2/multi-securityfilterchain-17016804731631.png)
...
![image-20231204230216259](SpringSecurity6+OAuth2/image-20231204230216259.png)
...
![image-20231205164049257](SpringSecurity6+OAuth2/image-20231205164049257.png)
...
![image-20231206022701725](SpringSecurity6+OAuth2/image-20231206022701725.png)
...
![image-20231206023030864](SpringSecurity6+OAuth2/image-20231206023030864.png)
...
![image-20230421184645177](SpringSecurity6+OAuth2/image-20230421184645177.png)
...
![image-20231209011827867](SpringSecurity6+OAuth2/image-20231209011827867.png)
...
<img src="SpringSecurity6+OAuth2/usernamepasswordauthenticationfilter-16822329079281.png" alt="usernamepasswordauthenticationfilter" style="zoom:67%;" />
...
![securitycontextholder](SpringSecurity6+OAuth2/securitycontextholder.png)
...
<img src="SpringSecurity6+OAuth2/image-20231222124053994.png" alt="image-20231222124053994" style="zoom:80%;" />
...
<img src="SpringSecurity6+OAuth2/image-20231222131233025.png" alt="image-20231222131233025" style="zoom:80%;" />

##### 开放API

例如云冲印服务的实现

<img src="SpringSecurity6+OAuth2/image-20231222131118611.png" alt="image-20231222131118611" style="zoom:80%;" />

#### 现代微服务安全

##### 单块应用安全

<img src="SpringSecurity6+OAuth2/image-20231222152734546.png" alt="image-20231222152734546" style="zoom:80%;" />



##### 微服务安全

<img src="SpringSecurity6+OAuth2/image-20231222152557861.png" alt="image-20231222152557861" style="zoom:80%;" />
...
![image-20231220180422742](SpringSecurity6+OAuth2/image-20231220180422742.png)



- 注册客户应用：客户应用如果想要访问资源服务器需要有凭证，需要在授权服务器上注册客户应用。注册后会**获取到一个ClientID和ClientSecrets**

<img src="SpringSecurity6+OAuth2/image-20231222203153125.png" alt="image-20231222203153125" style="zoom:80%;" />
...
​								![image-20231220185958063](SpringSecurity6+OAuth2/image-20231220185958063.png)



<img src="SpringSecurity6+OAuth2/image-20231222203218334.png" alt="image-20231222203218334" style="zoom: 80%;" />
...
![image-20231220190152888](SpringSecurity6+OAuth2/image-20231220190152888.png)

![image-20231222203240921](SpringSecurity6+OAuth2/image-20231222203240921.png)
...
![image-20231222203259785](SpringSecurity6+OAuth2/image-20231222203259785.png)



### 1.5、授权类型的选择

![image-20231223020052999](SpringSecurity6+OAuth2/image-20231223020052999.png)
...
![image-20231223164128030](SpringSecurity6+OAuth2/image-20231223164128030.png)
...
![image-20230510154255157](SpringSecurity6+OAuth2/image-20230510154255157.png)



填写应用信息：`默认的重定向URI模板为{baseUrl}/login/oauth2/code/{registrationId}`。registrationId是ClientRegistration的唯一标识符。

![image-20231221000906168](SpringSecurity6+OAuth2/image-20231221000906168.png)

获取应用程序id，生成应用程序密钥：

![image-20230510163101376](SpringSecurity6+OAuth2/image-20230510163101376.png)
...
![image-20230510165314829](SpringSecurity6+OAuth2/image-20230510165314829.png)
...
<img src="SpringSecurity6+OAuth2/image-20231223203225688.png" alt="image-20231223203225688" style="zoom:80%;" />
